      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center space-x-5">
        ...
        <div className="my-8">
          ...
          <div className="flex flex-col justify-center sm:flex-row my-5">
            ...
            />
            <button className=" bg-[#9A7AF1] hover:bg-[#8c59f9] transition-all duration-500 cursor-pointer text-white py-2 my-4 sm:my-0 sm:py-0 px-5 rounded-xl sm:rounded-l-none">
              Subscribe
            </button>
          </div>
        </div>
